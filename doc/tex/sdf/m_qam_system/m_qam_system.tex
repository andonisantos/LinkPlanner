...
\noindent where $P_L$ is the local oscillator power, $P_S$ is the average optical power of the laser source on which the signal is modulated, $G_{ele}$ is the gain in the transimpedance amplifier, $n_0/2$ is the noise spectral density and $B$ is the channel bandwidth. $A$ is the magnitude of the signal at sampling time and $\sqrt{N}$ is the RMS noise. Figure~\ref{fig:const_2m} shows the relation between the constellation points and $A$.
...
Substituting from equations~\ref{eq:rectSigEn} and~\ref{eq:noiseBw} into Equation~\ref{eq:berMQAMmf}, the BER expression becomes:

\begin{equation}\label{eq:berMod}
P_{be} = \frac{1}{2} \text{erfc}\left(\sqrt{\frac{A^2 T_s / 2}{ N / B}}\right) = 
\frac{1}{2} \text{erfc}\left(\frac{A}{\sqrt{N}} \sqrt{\frac{T_s}{2B}}\right) 
%= \frac{1}{2} \text{erfc}\left({\frac{A}{\sqrt{n_0}}}\right)
\end{equation}
...
Note that $N$ here is the noise power at the input of the matched filter, as is the bandwidth $B$. The expressions for the Bit-Error-Rate in the cases with and without matched filtering:
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $13.9624~dB$                             					\\ \hline
		numericalSNR Lower Bound & $13.8737~dB$                             					\\ \hline
	\end{tabular}
\end{table}
\begin{figure}[H]
		\centering
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $15.0408~dB$                             					\\ \hline
		numericalSNR Lower Bound & $14.9391~dB$                             					\\ \hline
		%		confidence             & $0.95$                                                     \\ \hline
		%		midReportSize          & $0$                                                        \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $14.7321~dB$                             					\\ \hline
		numericalSNR Lower Bound & $14.6327~dB$                             					\\ \hline
		%		confidence             & $0.95$                                                     \\ \hline
		%		midReportSize          & $0$                                                        \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $15.006~dB$                             					\\ \hline
		numericalSNR Lower Bound & $14.9329~dB$                             					\\ \hline
		%		confidence             & $0.95$                                                     \\ \hline
		%		midReportSize          & $0$                                                        \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $-1.0038~dB$                             					\\ \hline
		numericalSNR Lower Bound & $-1.1515~dB$                             					\\ \hline
		%		confidence             & $0.95$                                                     \\ \hline
		%		midReportSize          & $0$                                                        \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $0.120973~dB$                             					\\ \hline
		numericalSNR Lower Bound & $-0.064778~dB$                             					\\ \hline
		%		confidence             & $0.95$                                                     \\ \hline
		%		midReportSize          & $0$                                                        \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $-0.233164~dB$                             					\\ \hline
		numericalSNR Lower Bound & $-0.381006~dB$                             					\\ \hline
		%		confidence             & $0.95$                                                     \\ \hline
		%		midReportSize          & $0$                                                        \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|}
		...
		numericalSNR Upper Bound & $0.09153~dB$                             					\\ \hline
		numericalSNR Lower Bound & $-0.0185722~dB$                             					\\ \hline
		%		confidence             & $0.95$                                                     \\ \hline
		%		midReportSize          & $0$                                                        \\ \hline
	\end{tabular}
\end{table}
