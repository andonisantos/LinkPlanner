...
\textbf{Student Name}  &:& Diamantino Silva, August 18, 2017 - ...\\
\textbf{Goal}          &:& Simulation of quantum noise in double homodyne detection.\\
\textbf{Directory}     &:& sdf/optical_detection
\end{tabular}
\end{tcolorbox}
%
\vspace{2em}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{./sdf/quantum_noise/figures/thorlabs-manual-gain-spec-rf.png}
...
%
%
\putbib{./sdf/quantum\_noise/quantum\_noise.tex}
\end{bibunit}
