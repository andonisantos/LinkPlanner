...
An electric field can be expressed as an amplitude that varies in time, associated to a ?????
...
--construction--\\
--procurar referencias para isto--\\
--vou comecar por explicar as variaveis e explicar porque e que elas existem nesta equacao\\
--(Mark Fox, p.94, eq. 5.58)\\
\\
...
--NO-REFERENCES--\\
The electric field can be expressed an changing amplitude through time ???? assoc
...
%%
%%
Semi-Classical description of d\\
