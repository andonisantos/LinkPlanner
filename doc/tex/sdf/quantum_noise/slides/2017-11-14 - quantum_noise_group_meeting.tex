...
%--------------------------------------------------------------------------------------------------
%------------ SLIDE-------
\mysection{Quantum Noise - Theoretical xxxxx}\large
\vspace{0cm}
...
A signal is produced by the mopulation of a laser beam and attenuated. The Coherent Receiver uses this signal and a vacuum signal as input, outputing a voltage proportional to the homodyne detection????
