...
/*
	...
	*/
	...
	T1.initializeBlock(vector<Signal*> { &HMD12 }, vector<Signal*> { &TS1 }); //SNR estimation
	...
	T2.initializeBlock(vector<Signal*> { &HMD14 }, vector<Signal*> { &TS2 }); //SNR estimation
	B13.initializeBlock(vector<Signal*> { &TS2 }, vector<Signal*> { &HMD16 }); //Sampler
